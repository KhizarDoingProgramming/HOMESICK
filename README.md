...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=400&size=20&pause=1000&color=2C180F&center=true&vCenter=true&width=600&lines=>>+Initializing+dark+mode...;>>+Loading+Framer+Motion...;>>+Vibe+Check:+Passed" alt="Terminal Typing" />
</div>
...
### 🎨 Unmatched Aesthetic
- **Brutal & Beautiful:** Custom wobbly paint strokes and hand-drawn elements mixed with pixel-perfect modern geometry.
- **Dynamic Mix-Blend:** Intelligent navigation that automatically inverts (`mix-blend-difference`) based on what you're scrolling over.
...
│   ├── about/         # Who we are 
│   ├── blog/          # Thoughts & essays
│   ├── contact/       # Hit us up
│   └── globals.css    # Global design tokens
├── components/        # Reusable UI Architecture
│   ├── Hero.tsx       # Dynamic entry sequence
│   ├── Navbar.tsx     # Smart blend-mode navigation
│   ├── Marquee.tsx    # Infinite scrolling text
│   └── FinalCTA.tsx   # Conversion-optimized footer
└── public/            # Static assets & Custom Favicons
```
...
Want to spin this up on your own machine? Say less. Follow these steps to get the dev server running:

### 1. Clone the Repository
```bash
git clone git@github.com:KhizarDoingProgramming/HOMESICK.git
cd HOMESICK
```

### 2. Install Dependencies
We recommend using `npm` (or `pnpm`/`yarn` if that's your vibe).
```bash
npm install
```
...
npm run dev
```
Navigate to [http://localhost:3000](http://localhost:3000) and watch it come to life.
